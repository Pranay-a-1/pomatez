...
export const SHOW_PERSISTENT_POPUP = "SHOW_PERSISTENT_POPUP";
export const HIDE_PERSISTENT_POPUP = "HIDE_PERSISTENT_POPUP";
export const UPDATE_POPUP_TIME = "UPDATE_POPUP_TIME";
